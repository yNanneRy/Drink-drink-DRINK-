...
public class Drinkk extends javax.swing.JFrame {
    ...
    public void inicializaComponentesPersonalizados(){
        ...
        // Componentes que estão na primeira tela, e devem estar não-visiveis
        // até que o jogador aperte em "Iniciar".
        ...
        // Componentes que estão na segunda tela. Estes são aqueles que mostram
        // a pontuação de cada jogador e o jogador em si.
        ...
        // Perguntas e desafios TEMPORÁRIOS. Futuramente, o sistema terá conexão
        // com BDS para o preenchimento de perguntas e desafios em cada LinkedList.
        perguntas.add("Como foi a sua primeira vez?");
        perguntas.add("Já ficou com alguém da roda?");
        perguntas.add("Quem você beijaria dessa roda?");
        perguntas.add("Qual parte do corpo você beijaria da pessoa à sua esquerda?");
        perguntas.add("Qual sabor é gostoso de adicionar ao sexo oral?");
        perguntas.add("Quem é a pessoa mais sexy participando da brincadeira?");
        perguntas.add("Algemas ou vendas?");
        perguntas.add("Que tipo de música é perfeito para transar?");
        perguntas.add("Luzes acesas, meia luz ou apagadas?");
        perguntas.add("Qual o lugar mais inusitado que você já transou?");
        perguntas.add("Já transou com alguém do mesmo sexo?");
        perguntas.add("Qual a pior experiência sexual que você já teve?");
        perguntas.add("Mordida no pescoço ou lambida na orelha?");
        perguntas.add("1 ano na cadeia ou para todo o sempre com seu ex?");
        perguntas.add("Já foi traído?");
        ...
        perguntas.add("O que te faz gozar e não é sexo?");
        ...
        perguntas.add("Coxinha pela pontinha ou pela bundinha?");
        desafios.add("Fazer o máximo de flexões que você conseguir em 1 minuto.");
        desafios.add("Dê um beijo no pé da pessoa do seu lado direito.");
        ...
        desafios.add("Jogue capoeira com alguém da roda.");
        ...
        desafios.add("Fazer uma lap dance para alguém da roda.");
        desafios.add("Colocar um preservativo em uma banana ou pepino.");
        desafios.add("Massagear alguém da roda.");
        desafios.add("Fingir um orgasmo.");
        desafios.add("Sussurrar uma frase sensual no ouvido de alguém.");
        desafios.add("Beijar a orelha de alguém da roda.");
                            ...
                            .addGroup(SegundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(SegundoLayout.createSequentialGroup()
                                    .addGroup(SegundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, SegundoLayout.createSequentialGroup()
                                            .addGap(39, 39, 39)
        ...
        SegundoLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, SegundoLayout.createSequentialGroup()
                ...
                .addGroup(SegundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, SegundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(Jg12pnt, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(SegundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(SegundoLayout.createSequentialGroup()
                                        ...
                                        .addGroup(SegundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addComponent(Jg2pnt, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    .addComponent(Jg10pnt, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(SegundoLayout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                ...
                .addGroup(SegundoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(Jg8pnt, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void AdicionarBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarBTActionPerformed
        ...
        if(CDNome.getText().isBlank() == false){
            ...
            // Se a lista com o núemero de jogadores for menor que 6...
            if(jogadores.size() < 6){
    ...
    private void AdicionarJogadorBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarJogadorBTActionPerformed
        ...
        if (arregou == false && adicionar == false && jogadoresNaoAtivos.isEmpty() == false){
            ...
            // "adicionar" se torna true, por ter sido precionado, assim possibilitando
            ...
            // Os oultros botões ficam inativos pois o usuário quer adicionar uma pessoa ao jogo,
    ...
    private void VoltarBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VoltarBTActionPerformed
        ...
        // ou ter clicado em "ADICIONAR". Os dois terçao tratamento diferente aqui
        ...
        if (arregou == true){
            ...
            // Então, feita novamente a alternancia de cores.
            for(int i = 0; i < 12; i++){
